...
public class SimpleDbTest {
    private static SimpleDbImpl simpleDb;

    @BeforeAll
    public static void beforeAll() {
        simpleDb = new SimpleDbImpl("localhost", 3306, "simpleDb_test", "root", "1234");
    ...
    public void t001() {
        ...
        */
        ...
        int newId = sql.insert(); // AUTO_INCREMENT 에 의해서 생성된 주키 리턴
